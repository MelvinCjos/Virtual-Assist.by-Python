...
__all__ = [
    'SREStreamEnd', 'SITooLoud', 'SP_VISEME_5', 'eLEXTYPE_PRIVATE8',
    'SpeechFormatType', 'SpeechTokenValueCLSID', 'SP_VISEME_11',
    'SAFT32kHz8BitMono', 'DISPID_SDKOpenKey',
    'ISpeechObjectTokenCategory', 'SPLOADOPTIONS',
    'SPRECOGNIZERSTATUS', 'SpMMAudioOut', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SRGSetTextSelection', 'DISPID_SGRSTWeight', 'SVP_3',
    'SAFT44kHz16BitStereo', 'DISPID_SGRSTType',
    'DISPID_SpeechPhraseProperties', 'SpSharedRecoContext',
    'DISPID_SVGetAudioInputs', 'SVP_6', 'SpeechTokenKeyUI',
    'SVSFNLPSpeakPunc', 'DISPID_SRRSetTextFeedback', 'DISPID_SVVoice',
    'SPGRAMMARSTATE', 'SpeechVisemeType', 'eLEXTYPE_PRIVATE10',
    'DISPID_SVEWord', 'DISPID_SpeechPhraseElement',
    'DISPID_SRRAlternates', 'DISPID_SPEDisplayText',
    'SpeechBookmarkOptions', 'SAFT16kHz16BitMono', 'SpeechAudioState',
    'SpeechAllElements', 'SECNormalConfidence',
    'DISPID_SPRuleFirstElement', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SRRPhraseInfo', 'SRSActive', 'eLEXTYPE_MORPHOLOGY',
    'SP_VISEME_10', 'SpeechVoiceSkipTypeSentence', 'DISPID_SPRText',
    'DISPID_SPEActualConfidence', 'DISPID_SASNonBlockingIO',
    'SP_VISEME_6', 'LONG_PTR', 'DISPID_SPPParent',
    'DISPID_SGRSTPropertyName', 'SGDSActiveWithAutoPause',
    'SPGRAMMARWORDTYPE', 'SPPHRASE', 'DISPID_SFSOpen',
    'DISPID_SPRuleName', 'SPCT_SLEEP', 'DISPID_SVSRunningState',
    'SPPS_RESERVED3', 'SVSFNLPMask', 'SGDisplay',
    'Speech_StreamPos_RealTime', 'DISPID_SpeechLexiconWords',
    'SPRULE', 'DISPID_SRRTStreamTime', 'DISPID_SGRSTNextState',
    'DISPID_SPIProperties', 'eLEXTYPE_PRIVATE11',
    'DISPID_SRRRecoContext', 'DISPID_SGRSTPropertyId', 'SVEBookmark',
    'DISPID_SLWsCount', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SPAR_High', 'ISequentialStream', 'DISPID_SPIRetainedSizeBytes',
    'SpeechCategoryAudioIn', 'DISPID_SAStatus', 'DISPID_SVRate',
    'SAFT11kHz8BitMono', 'SVSFIsNotXML', 'SVF_None',
    'SAFTNoAssignedFormat', 'DISPID_SPRsCount', 'eWORDTYPE_ADDED',
    'DISPID_SGRsDynamic', 'ISpSerializeState',
    'ISpeechRecognizerStatus', 'eLEXTYPE_RESERVED4', 'SPAUDIOSTATE',
    'DISPID_SAFGetWaveFormatEx', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SDKSetLongValue',
    'SpeechVoiceEvents', 'SpeechUserTraining', 'SPSHT_Unknown',
    'DISPID_SRCEEndStream', 'SpeechTokenKeyFiles',
    'SpResourceManager', 'SGSExclusive', 'SPEI_TTS_BOOKMARK',
    'SpeechPropertyAdaptationOn', 'SPSHT_OTHER',
    'ISpPhoneticAlphabetSelection', 'SGLexicalNoSpecialChars',
    'DISPID_SVResume', 'SPRS_ACTIVE', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SpeechPartOfSpeech', 'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SAFType',
    'DISPID_SRGRecoContext', 'SVPNormal', 'SPSMF_SRGS_SAPIPROPERTIES',
    'eLEXTYPE_PRIVATE17', 'SPEI_VOICE_CHANGE', 'ISpeechFileStream',
    'SPWT_DISPLAY', 'DISPID_SVDisplayUI', 'SPCS_ENABLED',
    'DISPID_SGRSRule', 'SGRSTTWildcard', 'SRESoundEnd',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SCSBaseStream', 'SRARoot',
    'IInternetSecurityManager', 'SDKLCurrentUser', 'DISPID_SOTsItem',
    'SPEI_PHRASE_START', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SRCRecognizer', 'SpeechRecognizerState',
    'SPDATAKEYLOCATION', 'DISPID_SABIMinNotification', 'SP_VISEME_17',
    'SVP_1', 'SVP_9', 'SAFTTrueSpeech_8kHz1BitMono',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'ISpObjectWithToken',
    'SGRSTTTextBuffer', 'DISPID_SVStatus', 'SITooSlow',
    'DISPID_SOTGetAttribute', 'SpObjectToken', 'DISPID_SGRsAdd',
    'DISPID_SOTRemove', 'SPPHRASEPROPERTY', 'SPWAVEFORMATTYPE',
    'SPFM_NUM_MODES', 'SAFT22kHz16BitStereo',
    'SpeechPropertyResponseSpeed', 'SPEI_SR_PRIVATE',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SGRs_NewEnum',
    'DISPID_SVWaitUntilDone', 'DISPID_SRCCreateGrammar',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SRAudioInputStream',
    'SPBO_PAUSE', 'SpeechLexiconType', 'SAFT11kHz16BitMono',
    'DISPID_SPEDisplayAttributes', 'SAFTText',
    'SPINTERFERENCE_LATENCY_WARNING', 'SAFT11kHz16BitStereo',
    'SPEI_PHONEME', 'SDA_One_Trailing_Space', 'SpeechGrammarWordType',
    'ISpNotifyTranslator', 'DISPID_SASFreeBufferSpace',
    'DISPID_SRCCmdMaxAlternates', 'SVP_11', 'SpeechEngineConfidence',
    'SWTAdded', 'DISPID_SRSClsidEngine', 'DISPID_SLPsCount',
    'DISPID_SOTCId', 'DISPID_SRStatus', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SRCResume', 'eLEXTYPE_PRIVATE7', 'DISPID_SFSClose',
    'SPPS_Function', 'ISpRecognizer2', 'SDTPronunciation',
    'DISPID_SVSInputSentencePosition', 'DISPID_SRRAudio',
    'DISPID_SPRNumberOfElements', 'DISPID_SGRAddResource',
    'SECFIgnoreWidth', 'eLEXTYPE_PRIVATE1', 'SPAR_Unknown',
    'SVSFDefault', 'SPAR_Low', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SGRsCommit', 'DISPID_SASCurrentDevicePosition', 'SVP_12',
    'SpeechSpecialTransitionType', 'ISpeechPhraseAlternate',
    'DISPID_SRGCmdLoadFromObject', 'SpeechRecoProfileProperties',
    'DISPID_SPRuleParent', 'SPSHT_EMAIL',
    'DISPID_SRGCmdLoadFromResource', 'ISpeechBaseStream',
    'DISPID_SLWPronunciations', 'DISPID_SRGetRecognizers',
    'SPSTREAMFORMATTYPE', 'SPWORDPRONOUNCEABLE', 'SpLexicon',
    'ISpNotifySink', 'SAFT48kHz8BitStereo', 'SPDKL_CurrentUser',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SVSInputSentenceLength',
    'SPEI_TTS_AUDIO_LEVEL', 'SpeechDisplayAttributes',
    'DISPID_SPCPhoneToId', 'SpFileStream',
    'SPEI_PROPERTY_STRING_CHANGE', 'ISpStreamFormat',
    'SDTLexicalForm', 'DISPID_SASCurrentSeekPosition', 'SPAS_PAUSE',
    'DISPID_SGRSTransitions', 'DISPID_SpeechVoiceEvent',
    'ISpeechPhraseReplacement', 'DISPID_SRCSetAdaptationData',
    'SPCS_DISABLED', 'DISPID_SLPs_NewEnum', 'SGLexical',
    'SP_VISEME_2', 'DISPID_SRSetPropertyString',
    'DISPID_SVEventInterests', 'DISPID_SRGRules',
    'DISPID_SGRAttributes', 'DISPID_SOTCreateInstance', 'SBOPause',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SPRsItem',
    'DISPID_SRGDictationUnload', 'SPPHRASEREPLACEMENT',
    'SVSFUnusedFlags', 'SSFMOpenForRead', 'DISPID_SVPause',
    'SpeechGrammarTagWildcard', 'SVSFParseSapi', 'SPEI_RECOGNITION',
    'SpeechAudioFormatType', 'SP_VISEME_7',
    'SAFTCCITT_ALaw_44kHzStereo', 'SAFT8kHz16BitMono', 'SPVPRIORITY',
    'DISPID_SpeechRecognizer', 'SpeechVoicePriority',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SVF_Emphasis',
    'DISPID_SpeechFileStream', 'SpeechTokenIdUserLexicon',
    'DISPID_SLWType', 'SPEI_SOUND_START', 'SVP_10', 'SPXRO_SML',
    'ISpPhraseAlt', '_SPAUDIOSTATE',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SpUnCompressedLexicon',
    'SPBO_AHEAD', 'DISPID_SVEViseme', 'SPEI_WORD_BOUNDARY',
    'ISpeechPhoneConverter', 'DISPID_SABIBufferSize',
    'DISPID_SPEEngineConfidence', 'DISPID_SRCEBookmark',
    'DISPID_SRRTLength', 'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SOTId',
    'eLEXTYPE_PRIVATE13', 'SPFM_OPEN_READONLY', 'SPFM_CREATE',
    'SPEI_RESERVED3', 'SpeechRecoEvents', 'SREPhraseStart',
    'SPFM_CREATE_ALWAYS', 'DISPID_SpeechGrammarRule',
    'SpeechAudioFormatGUIDText', 'SpStreamFormatConverter',
    'eLEXTYPE_PRIVATE19', 'DISPID_SpeechObjectToken', 'SP_VISEME_13',
    'DISPID_SpeechPhraseAlternate', 'SRSInactive',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SPIAudioSizeTime',
    'ISpeechLexicon', 'SWPUnknownWordPronounceable', 'SPSLMA',
    'SRCS_Disabled', 'DISPID_SGRSTsCount', 'SGRSTTRule',
    'SAFTCCITT_uLaw_44kHzStereo', 'SAFTADPCM_44kHzStereo',
    'DISPID_SLAddPronunciation', 'SpInProcRecoContext',
    'SpNotifyTranslator', 'DISPID_SRCEAdaptation',
    'DISPID_SGRInitialState', 'SPEVENT', 'eLEXTYPE_USER_SHORTCUT',
    'SVSFParseAutodetect', 'SECHighConfidence', 'SPPS_LMA',
    'STSF_AppData', 'DISPID_SLWs_NewEnum', 'SAFT8kHz8BitStereo',
    'ISpPhrase', 'SRESoundStart', 'SpeechEmulationCompareFlags',
    ...
    'DISPID_SRIsUISupported', 'SpAudioFormat', 'SVSFVoiceMask',
    'SpeechRecognitionType', 'SREAdaptation', 'ISpeechGrammarRules',
    'ISpResourceManager', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SRState', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SGRsItem', 'DISPID_SRGetPropertyString',
    'SPRST_INACTIVE_WITH_PURGE', 'SVEWordBoundary',
    'SAFT24kHz8BitStereo', 'DISPID_SpeechPhraseInfo',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SLPSymbolic',
    'ISpObjectTokenCategory', 'SVPOver', 'DISPID_SVEEnginePrivate',
    'SPSHORTCUTPAIR', 'SP_VISEME_0', 'SpPhraseInfoBuilder',
    'SDTAlternates', 'SPEI_END_SR_STREAM', 'SPRST_NUM_STATES',
    'DISPID_SBSRead', 'ISpeechPhraseElements',
    'SSSPTRelativeToCurrentPosition', 'ISpRecoGrammar2',
    'DISPID_SPAsItem', 'SpeechStreamSeekPositionType',
    'SPPROPERTYINFO', 'SpeechGrammarState', 'SpeechTokenContext',
    'DISPID_SRCVoice', 'DISPID_SPEAudioTimeOffset', 'SITooFast',
    'SDKLCurrentConfig', 'DISPID_SOTCDefault', 'SpVoice', 'SASStop',
    'DISPID_SPPs_NewEnum', 'SVP_0', 'DISPID_SpeechLexicon',
    'DISPID_SVEPhoneme', 'DISPID_SRAudioInput',
    'SpeechGrammarTagUnlimitedDictation', 'ISpeechGrammarRuleState',
    'SpCompressedLexicon', 'DISPID_SLAddPronunciationByPhoneIds',
    'ISpeechMMSysAudio', 'DISPID_SWFEBitsPerSample', 'SREPrivate',
    'SDA_No_Trailing_Space', 'SAFTCCITT_ALaw_44kHzMono',
    'SAFTGSM610_8kHzMono', 'DISPID_SAEventHandle',
    'DISPID_SpeechVoiceStatus', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SRGCommit', 'ISpXMLRecoResult', 'eLEXTYPE_PRIVATE20',
    'DISPID_SABufferNotifySize', 'SWPKnownWordPronounceable',
    'SVF_Stressed', 'DISPID_SpeechPhraseAlternates', 'SP_VISEME_4',
    'SPVPRI_ALERT', 'SAFTCCITT_ALaw_11kHzMono',
    'SAFT24kHz16BitStereo', 'SDTAll', 'SAFT44kHz8BitMono',
    'SPEI_REQUEST_UI', 'SPPS_Verb', 'DISPID_SRCEFalseRecognition',
    'DISPID_SVSLastBookmarkId', 'eLEXTYPE_APP', 'SAFT44kHz16BitMono',
    'SVPAlert', 'DISPID_SRSAudioStatus', 'SPEI_START_INPUT_STREAM',
    'SPAUDIOOPTIONS', 'DISPID_SGRsFindRule', 'DISPID_SVIsUISupported',
    'SPRECOSTATE', 'ISpeechTextSelectionInformation', 'DISPID_SPPId',
    'DISPID_SLGetWords', 'DISPID_SPPName', 'SPSEMANTICFORMAT',
    'DISPID_SOTDisplayUI', 'SAFT8kHz8BitMono',
    'SAFTCCITT_uLaw_11kHzMono', 'SBONone', 'SpWaveFormatEx',
    'SAFTGSM610_44kHzMono', 'SPSVerb', 'SAFTADPCM_11kHzStereo',
    'DISPID_SpeechPhraseReplacements', 'tagSTATSTG', 'SGSDisabled',
    'DISPID_SLWLangId', 'ISpeechVoice', 'SECFIgnoreCase',
    'DISPID_SRGDictationSetState', 'SpeechVoiceCategoryTTSRate',
    'DISPIDSPRG', 'DISPID_SRCBookmark', 'SpMemoryStream',
    'SpeechEngineProperties', 'DISPID_SDKEnumKeys', 'SPEVENTENUM',
    'SpObjectTokenCategory', 'SSTTDictation', 'SPSEMANTICERRORINFO',
    ...
    'DISPID_SGRsCount', 'SAFTNonStandardFormat', 'SPAS_RUN',
    'DISPID_SVSVisemeId', 'eLEXTYPE_PRIVATE4', 'DISPID_SRCERequestUI',
    'ISpDataKey', 'DISPID_SPRs_NewEnum', 'DISPID_SPEsItem',
    'ISpeechXMLRecoResult', 'ISpProperties', 'SP_VISEME_3',
    'SECFIgnoreKanaType', 'SRADynamic', 'ISpRecognizer',
    'DISPID_SpeechPhraseRule', 'SPSFunction',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SpeechVoice',
    'DISPID_SRCEInterference', 'SVEAllEvents',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPEI_HYPOTHESIS',
    'SGDSInactive', 'DISPID_SLGetPronunciations', 'UINT_PTR',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPPS_SuppressWord', 'SVP_21', 'DISPID_SpeechCustomStream',
    'SVP_15', 'SpStream', 'SPVOICESTATUS', 'eLEXTYPE_PRIVATE3',
    'DISPID_SPEAudioStreamOffset', 'Speech_StreamPos_Asap',
    'SREStateChange', 'SVEStartInputStream', 'DISPID_SPISaveToMemory',
    'DISPID_SpeechPhraseElements', 'DISPID_SRCEHypothesis', 'SVP_2',
    'SAFT12kHz16BitStereo', 'DISPID_SPACommit', 'SVEPrivate',
    'SREInterference', 'SGDSActiveUserDelimited', 'DISPID_SRGId',
    'DISPID_SDKDeleteValue', 'DISPID_SpeechMMSysAudio',
    'SDTReplacement', 'DISPID_SBSWrite',
    'DISPID_SPANumberOfElementsInResult', 'STCInprocHandler',
    'DISPID_SDKSetStringValue', 'ISpRecognizer3',
    'ISpeechObjectTokens', 'SAFT24kHz8BitMono',
    'DISPID_SPELexicalForm', 'SPPARTOFSPEECH',
    'ISpeechPhraseProperties', 'SPSUnknown',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SVGetVoices',
    'DISPID_SASState', 'SPLEXICONTYPE', 'DISPID_SWFESamplesPerSec',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SpeechRecoResult',
    'SpShortcut', 'SRATopLevel', 'ISpeechRecoResultTimes',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SGRsCommitAndSave', 'SINoise',
    'SPEI_RESERVED5', 'SVP_5', 'ISpNotifySource',
    'DISPID_SMSADeviceId', 'SPWT_LEXICAL', 'SPINTERFERENCE',
    'SPCT_SUB_DICTATION', 'ISpShortcut', 'ISpeechPhraseReplacements',
    'SPWF_SRENGINE', 'SPRS_INACTIVE', 'DISPID_SPRulesItem',
    'SpeechDiscardType', 'DISPID_SPERetainedSizeBytes',
    'SRTExtendableParse', 'ISpeechMemoryStream', 'DISPID_SRIsShared',
    'SPEI_END_INPUT_STREAM', 'SAFT44kHz8BitStereo', 'SPGS_EXCLUSIVE',
    'ISpStreamFormatConverter', 'SDTProperty',
    'DISPID_SpeechAudioFormat', 'DISPID_SVGetProfiles',
    'ISpRecoCategory', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SGPronounciation', 'eLEXTYPE_PRIVATE9', 'SVESentenceBoundary',
    'SREBookmark', 'SAFT12kHz8BitMono', 'DISPID_SVSLastBookmark',
    'eLEXTYPE_PRIVATE5', 'SPEI_SR_BOOKMARK',
    'DISPID_SRSetPropertyNumber', 'SpInprocRecognizer',
    'DISPID_SPIEngineId', 'SAFT12kHz16BitMono', 'SVEEndInputStream',
    'DISPID_SpeechPhoneConverter', 'SVEPhoneme', 'SPPS_Interjection',
    'DISPID_SRRDiscardResultInfo', 'SLTUser', 'SPSERIALIZEDRESULT',
    'DISPID_SRCRetainedAudio', 'WAVEFORMATEX', 'SAFT22kHz16BitMono',
    ...
    'DISPID_SRDisplayUI', 'SPRST_INACTIVE', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SRCRetainedAudioFormat', 'SINoSignal',
    'DISPID_SpeechRecognizerStatus', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SpeechLexiconProns', 'SRAInterpreter', 'SpCustomStream',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SLPPartOfSpeech',
    'DISPID_SMSALineId', 'DISPID_SPEAudioSizeTime', 'SPSModifier',
    'ISpEventSink', 'SDA_Consume_Leading_Spaces', 'SPSMF_UPS',
    'DISPID_SPEsCount', 'SpeechWordPronounceable',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SABufferInfo',
    'DISPID_SOTGetDescription', 'SpeechStreamFileMode', 'SVP_17',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SWFEFormatTag',
    'SP_VISEME_9', 'DISPID_SPIStartTime', 'SPAS_CLOSED', 'SVP_19',
    'IEnumSpObjectTokens', 'SPEI_MAX_TTS',
    'DISPID_SVAudioOutputStream', 'DISPID_SVSyncronousSpeakTimeout',
    '_ISpeechVoiceEvents', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SGRClear', 'DISPID_SOTDataKey', 'SPGS_DISABLED',
    'DISPID_SRCCreateResultFromMemory', 'ISpPhoneConverter',
    'DISPID_SRRGetXMLResult', 'DISPID_SWFEChannels',
    'DISPID_SpeechWaveFormatEx', 'SP_VISEME_18', 'SPEI_ADAPTATION',
    'SVSFParseSsml', 'DISPID_SPRuleNumberOfElements', 'SPPS_Unknown',
    'SPPS_Noncontent', 'SVP_4', 'SPEVENTSOURCEINFO',
    'DISPID_SVSPhonemeId', 'SPGS_ENABLED', 'SSSPTRelativeToStart',
    'DISPID_SVSInputWordPosition', 'SVSFParseMask', 'SGSEnabled',
    'SVSFPersistXML', 'SPSMF_SAPI_PROPERTIES',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SpeechAudioBufferInfo',
    '__MIDL_IWinTypes_0009', 'DISPID_SAFGuid', 'SPLO_STATIC',
    'SpeechTokenKeyAttributes', 'SPEI_VISEME',
    'DISPID_SPEPronunciation', 'SVEViseme', 'DISPID_SDKDeleteKey',
    'SVP_14', 'SSSPTRelativeToEnd', 'DISPID_SWFEBlockAlign',
    'SpeechAudioVolume', 'DISPID_SPPConfidence',
    'DISPID_SOTGetStorageFileName', 'SVEVoiceChange', 'SDTRule',
    'SAFTADPCM_22kHzMono', 'SPVPRI_NORMAL', 'ISpeechAudio',
    'SPBO_NONE', 'DISPID_SPAStartElementInResult', 'ISpObjectToken',
    'DISPID_SpeechAudio', 'SRTStandard',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SPRuleId',
    'DISPID_SPIReplacements', 'ISpRecoContext', 'SECFEmulateResult',
    'DISPID_SPCIdToPhone', 'DISPID_SRGCmdSetRuleIdState',
    'eLEXTYPE_PRIVATE16', 'DISPID_SPAs_NewEnum', 'SREAudioLevel',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'STSF_CommonAppData',
    'SPWORDPRONUNCIATION', 'DISPID_SRRSpeakAudio', 'SPWORDTYPE',
    'DISPID_SLWsItem', 'SPPS_RESERVED4', 'ISpLexicon', 'SP_VISEME_8',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SOTCGetDataKey',
    'DISPID_SLRemovePronunciation', 'SPSHT_NotOverriden',
    'SPAR_Medium', 'SAFTCCITT_uLaw_22kHzStereo', 'SAFT48kHz8BitMono',
    'DISPID_SLPPhoneIds', 'SREAllEvents', 'SPWORDPRONUNCIATIONLIST',
    'SDTAudio', 'SAFTADPCM_8kHzStereo', 'SSTTTextBuffer',
    'ISpEventSource', 'DISPID_SREmulateRecognition',
    'ISpGrammarBuilder', 'DISPID_SRCESoundStart',
    'DISPID_SPRuleChildren', 'SASRun', 'SPEI_RESERVED6',
    'SP_VISEME_19', 'SpeechCategoryRecoProfiles',
    'SpeechAudioFormatGUIDWave', 'DISPID_SAVolume',
    'SpeechCategoryVoices', 'SPADAPTATIONRELEVANCE',
    'SPAUDIOBUFFERINFO', 'DISPID_SOTsCount', 'SpeechWordType',
    'SpMMAudioIn', 'SpSharedRecognizer',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPRULESTATE',
    'SPINTERFERENCE_TOOLOUD', 'SAFTCCITT_uLaw_8kHzStereo',
    'STCRemoteServer', 'DISPID_SpeechMemoryStream', 'SVSFlagsAsync',
    'SAFT16kHz16BitStereo', 'SPBINARYGRAMMAR', 'SAFT32kHz16BitStereo',
    'DISPID_SpeechGrammarRuleState', 'SP_VISEME_12', 'SPWF_INPUT',
    'ISpeechLexiconWords', 'DISPID_SRCEPropertyStringChange',
    'SWTDeleted', 'DISPID_SPIRule', 'SPVISEMES',
    'DISPID_SpeechDataKey', 'ISpeechPhraseRules', 'SRSEDone',
    'SAFT11kHz8BitStereo', 'SSFMOpenReadWrite',
    'DISPID_SPERequiredConfidence', 'SPEI_SOUND_END',
    'DISPID_SVEVoiceChange', 'DISPID_SGRName', 'SFTInput', 'SRAONone',
    'SDTDisplayText', 'eLEXTYPE_RESERVED7',
    'SpeechPropertyComplexResponseSpeed', 'ISpeechWaveFormatEx',
    'SVP_18', 'SpeechRuleState', 'DISPID_SRCreateRecoContext',
    'SpeechMicTraining', 'ISpeechObjectToken', 'ISpeechRecoResult2',
    'SpNullPhoneConverter', 'SSFMCreateForWrite', 'SP_VISEME_15',
    'SPSERIALIZEDPHRASE', 'ISpeechPhraseRule', 'DISPID_SVPriority',
    'SVP_7', 'SAFT22kHz8BitStereo', 'DISPID_SGRSAddWordTransition',
    'DISPID_SRRTimes', '_RemotableHandle', 'ISpeechPhraseAlternates',
    'DISPID_SPCLangId', 'SPRECORESULTTIMES', 'Speech_Default_Weight',
    'DISPID_SLPsItem', 'ISpeechLexiconWord', 'DISPID_SPPFirstElement',
    'SAFT48kHz16BitMono', 'eWORDTYPE_DELETED', 'SPEI_START_SR_STREAM',
    'SPCT_COMMAND', 'SRADefaultToActive', 'SITooQuiet',
    'SPSHORTCUTTYPE', 'ISpeechLexiconPronunciation', 'ISpVoice',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPBO_TIME_UNITS',
    'DISPID_SASetState', 'DISPID_SRCERecognizerStateChange',
    'SVSFIsFilename', 'SpPhoneConverter', 'DISPID_SVEStreamEnd',
    'ISpRecoResult', 'SVP_13', 'SAFT24kHz16BitMono', 'SRSEIsSpeaking',
    'ISpeechRecoGrammar', 'SVP_16', 'SAFT12kHz8BitStereo',
    'DISPID_SpeechPhraseProperty', 'DISPID_SAFSetWaveFormatEx',
    'SP_VISEME_16', 'DISPID_SRRecognizer', 'eLEXTYPE_USER',
    'eLEXTYPE_PRIVATE15', 'DISPID_SpeechBaseStream',
    'SAFT16kHz8BitMono', 'SpeechCategoryRecognizers',
    'STSF_FlagCreate', 'DISPID_SPIAudioStreamPosition',
    'SWPUnknownWordUnpronounceable', 'SpeechRunState',
    'DISPID_SPPNumberOfElements', 'SREHypothesis', 'STCLocalServer',
    'DISPID_SPAsCount', 'SPSInterjection', 'SRTAutopause',
    'DISPID_SOTCategory', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SLWWord', 'DISPID_SGRSTPropertyValue',
    'DISPID_SRCEventInterests', 'DISPID_SRCPause', 'SPAO_NONE',
    'SAFTExtendedAudioFormat', 'SSFMCreate', 'DISPID_SPPChildren',
    'SRAORetainAudio', 'DISPID_SVAudioOutput', 'ISpeechRecognizer',
    'SRCS_Enabled', 'DISPID_SVSLastResult', 'SSTTWildcard',
    'DISPID_SABIEventBias', 'SpeechPropertyHighConfidenceThreshold',
    'SPSNoun', 'SAFT22kHz8BitMono', 'DISPID_SPRules_NewEnum',
    'DISPID_SDKGetlongValue', 'SAFT48kHz16BitStereo',
    'SAFTADPCM_11kHzMono', 'DISPID_SBSSeek',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'ISpeechAudioBufferInfo',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SOTSetId', 'SRERecognition',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SVVolume', 'SPPS_RESERVED1', 'SAFTCCITT_ALaw_8kHzMono',
    'Speech_Max_Word_Length', 'SRERecoOtherContext',
    'SPSHORTCUTPAIRLIST', 'SRAExport', 'SPVPRI_OVER',
    'DISPID_SOTIsUISupported', 'SRTSMLTimeout',
    'DISPID_SpeechObjectTokenCategory', 'ISpeechDataKey',
    'DISPID_SRCERecognition', 'SREFalseRecognition', 'SPWORD',
    'SFTSREngine', 'SAFTCCITT_ALaw_8kHzStereo', 'SPPHRASEELEMENT',
    'ISpMMSysAudio', 'DISPID_SRRAudioFormat',
    'SPRS_ACTIVE_USER_DELIMITED',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SPEI_RECO_OTHER_CONTEXT', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SPIEnginePrivateData', 'SPSNotOverriden',
    'SpeechRegistryLocalMachineRoot', 'eLEXTYPE_RESERVED9', 'SINone',
    'SAFTGSM610_22kHzMono', 'DISPID_SPPsItem', 'SPDKL_CurrentConfig',
    'ISpeechAudioFormat', 'DISPID_SRSCurrentStreamNumber',
    'SPDKL_LocalMachine', 'SPCONTEXTSTATE', 'SVEAudioLevel',
    'SPRECOCONTEXTSTATUS', 'IEnumString', 'SP_VISEME_21',
    'ISpeechRecoResultDispatch', 'DISPID_SPAPhraseInfo',
    'SAFTADPCM_44kHzMono', 'DISPID_SWFEExtraData',
    'SPBOOKMARKOPTIONS', 'SECFDefault', 'DISPID_SRProfile',
    'DISPID_SPPEngineConfidence', 'SPEI_RESERVED2',
    'SpeechTokenShellFolder', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SPARecoResult', 'SpeechInterference',
    'DISPID_SGRSAddRuleTransition', 'SAFTADPCM_22kHzStereo',
    'eLEXTYPE_PRIVATE6', 'ISpRecoGrammar', 'DISPID_SRGState',
    'ISpeechResourceLoader', 'SPEI_SENTENCE_BOUNDARY',
    'SPPS_Modifier', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SMSAMMHandle', 'SAFT8kHz16BitStereo',
    'SAFTADPCM_8kHzMono', 'DISPID_SOTCSetId', 'SPPS_Noun', 'SVP_20',
    'DISPID_SRSSupportedLanguages', 'DISPID_SRCEAudioLevel',
    'SGRSTTEpsilon', 'SDA_Two_Trailing_Spaces', 'ISpeechPhraseInfo',
    'SVSFPurgeBeforeSpeak', 'SPLO_DYNAMIC',
    'SpeechCategoryPhoneConverters', 'SDKLDefaultLocation',
    'DISPID_SVSkip', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SRGDictationLoad', 'DISPID_SGRAddState',
    'DISPID_SVEAudioLevel', 'SPXRO_Alternates_SML',
    'DISPID_SpeechRecoContext', 'DISPID_SPRulesCount', 'SAFTDefault',
    'DISPID_SRGReset', 'DISPID_SGRSTsItem', 'SpeechVisemeFeature',
    'SAFTGSM610_11kHzMono', 'SPCATEGORYTYPE', 'DISPID_SPILanguageId',
    'SRTEmulated', 'SpeechCategoryAppLexicons', 'DISPID_SDKCreateKey',
    'Speech_Max_Pron_Length', 'SREPropertyNumChange',
    'DISPID_SRCEEnginePrivate', 'SRERequestUI', 'SLTApp',
    'ISpPhoneticAlphabetConverter', 'SP_VISEME_20',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SBSFormat', 'DISPID_SMSSetData',
    'ISpeechPhraseProperty', 'ISpeechVoiceStatus',
    'DISPID_SRCESoundEnd', 'eLEXTYPE_RESERVED6', 'DISPID_SGRSTRule',
    'SVSFIsXML', 'DISPID_SRGCmdLoadFromFile', 'DISPID_SDKEnumValues',
    'DISPID_SPRuleConfidence', 'DISPID_SVSCurrentStreamNumber',
    'SPEI_RESERVED1', 'DISPID_SpeechGrammarRules',
    'SpeechRegistryUserRoot', 'DISPID_SRCEStartStream',
    'eLEXTYPE_PRIVATE18', 'SGDSActive', 'DISPID_SVSpeakStream',
    'tagSPPROPERTYINFO', 'SpeechCategoryAudioOut',
    'DISPID_SpeechRecoResult2', 'ISpeechRecoContext', 'ISpStream',
    'DISPID_SVAlertBoundary', 'DISPID_SDKGetBinaryValue',
    'DISPID_SLPType', 'DISPID_SLPLangId',
    'SpeechDictationTopicSpelling', 'DISPID_SPIElements',
    'eLEXTYPE_RESERVED10', 'ISpAudio', 'DISPID_SRRGetXMLErrorInfo',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SRRSaveToMemory',
    'SPWORDLIST', 'ISpRecoContext2', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SRSNumberOfActiveRules', 'SPEI_MIN_TTS',
    'SPEI_TTS_PRIVATE', 'STCAll', 'SPRST_ACTIVE', 'SRAImport',
    'DISPID_SADefaultFormat', 'SPINTERFERENCE_NOISE',
    'SpeechLoadOption', 'eLEXTYPE_PRIVATE2', 'ISpeechGrammarRule',
    'SLOStatic', 'SPEI_UNDEFINED', 'SPSSuppressWord',
    'eLEXTYPE_LETTERTOSOUND', 'SPEI_INTERFERENCE',
    'DISPIDSPTSI_SelectionOffset', 'SDKLLocalMachine', 'SP_VISEME_1',
    'SAFT32kHz8BitStereo', 'DISPID_SPIAudioSizeBytes', 'SPAS_STOP',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SPIGetText',
    'DISPID_SPRDisplayAttributes', 'SpeechPropertyResourceUsage',
    'SREPropertyStringChange', 'ISpeechPhraseInfoBuilder',
    'SLODynamic', 'DISPID_SVSpeak', 'SPWT_PRONUNCIATION',
    'DISPID_SRCVoicePurgeEvent', 'SPDKL_DefaultLocation',
    'SREStreamStart', 'SPPHRASERULE', 'DISPID_SVEBookmark',
    'ISpeechLexiconPronunciations', 'SpeechAddRemoveWord',
    'ISpeechCustomStream', 'SPEI_MIN_SR',
    'DISPID_SRGetPropertyNumber', 'SPEI_MAX_SR',
    'DISPID_SpeechAudioStatus', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SpeechLexiconWord', 'SpTextSelectionInformation',
    'SPPS_NotOverriden', 'SPCT_SUB_COMMAND', 'DISPID_SRGetFormat',
    'STSF_LocalAppData', 'SP_VISEME_14', 'SVP_8',
    'SECFNoSpecialChars', 'SAFT32kHz16BitMono', 'DISPIDSPTSI',
    'SPFM_OPEN_READWRITE', 'DISPID_SRCEPhraseStart',
    'SPXMLRESULTOPTIONS', 'SECLowConfidence', 'SASClosed',
    'DISPID_SLGetGenerationChange', 'SpeechRuleAttributes',
    'DISPID_SRCState', 'SPTEXTSELECTIONINFO',
    'DISPID_SOTMatchesAttributes', 'ISpeechPhraseElement',
    'ISpeechRecoResult', 'DISPID_SPEs_NewEnum', 'DISPID_SPIGrammarId',
    'DISPID_SVSInputWordLength', 'SpeechDataKeyLocation', 'SRTReSent',
    'DISPID_SGRId', 'SPCT_DICTATION', 'SGRSTTDictation',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SVESentenceBoundary',
    'SGRSTTWord', 'DISPID_SGRSTText', 'SPFILEMODE', 'SPPS_RESERVED2',
    'eLEXTYPE_PRIVATE12', 'SRSInactiveWithPurge',
    '_ISpeechRecoContextEvents', 'DISPID_SpeechObjectTokens',
    'SpeechRecoContextState', 'SPINTERFERENCE_NONE',
    'SAFT16kHz8BitStereo', 'SRSActiveAlways', 'SPAUDIOSTATUS',
    'DISPID_SPPValue', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SPERetainedStreamOffset',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SPPsCount',
    'SPEI_RECO_STATE_CHANGE', 'IStream', 'STCInprocServer',
    'DISPID_SpeechPhraseRules', 'DISPID_SMSGetData',
    'SpPhoneticAlphabetConverter', 'SpeechGrammarTagDictation',
    'SpMMAudioEnum', 'SpeechRetainedAudioOptions'
]
